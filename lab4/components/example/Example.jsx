    ...
    return (
      <div className="container Example">
        ...
        <div className="motto-update">
          ...
          <span className= "cs142-example-output">Change ur motto : 
            <input type="text" value={this.state.motto} onChange={(event)=>this.handleChange2(event)}/> 
          </span>
            <p className="cs142-example-code">{this.state.motto}</p>
        </div>
